...
pad 80 "│ ┌" "─" "┴────────────────────────────────────────────────┤"
echo "╞═╪▶ $(tput setaf 4)WEST.H5 ITERATION$(tput sgr0) ─────────────────────────────────────── $(tput setaf 4)? REMAINING$(tput sgr0) │"
pad 80  "│ ├"    "─"    "┤"
...
echo "│$(tput setaf 1)𐄂$(tput sgr0)├▶ $(tput setaf 1)SLURM │ WESTPA ERROR$(tput sgr0) ──┤$(tput setaf 3)★$(tput sgr0)├▶ $(tput setaf 3)OLD SUBMISSIONS$(tput sgr0) ──────────────────────────────┤"
pad 80 "│ ├" "─" "┤ ├────────────────────────────────────────────────┤"
...
pad 80 "│ ├" "─" "┤ ├────────────────────────────────────────────────┤"
echo "│$(tput setaf 4)✔$(tput sgr0)├▶ $(tput setaf 4)$(printf '%09d' $TARGET_ITERATIONS) ITERS DONE$(tput sgr0) ──┤$(tput setaf 2)+$(tput sgr0)├▶ $(tput setaf 2)NEW SUBMISSIONS$(tput sgr0) ──────────────────────────────┤"
pad 80 "│ ├" "─" "┤ ├────────────────────────────────────────────────┤"
